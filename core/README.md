...
```typescript
import { Region } from "@anaidev/daw-engine-core";
...
```typescript
import { AudioEngine, AudioProvider } from "@anaidev/daw-engine-core";
...
Implement this interface to connect @anaidev/daw-engine-core to any audio system.

```typescript
import { AudioProvider } from "@anaidev/daw-engine-core";
...
```typescript
import { CommandExecutor, CommandType } from "@anaidev/daw-engine-core";
...
```typescript
import { CommandHandler, CommandResult } from "@anaidev/daw-engine-core";
...
```typescript
import { PluginManager } from "@anaidev/daw-engine-core";
...
```typescript
import { AutomationList, AutomationMode } from "@anaidev/daw-engine-core";
...
```typescript
import { ActionRegistry, ActionCategory } from "@anaidev/daw-engine-core";
...
```typescript
import { KeyBindings } from "@anaidev/daw-engine-core";
...
```typescript
import { Preferences } from "@anaidev/daw-engine-core";
...
```typescript
import { SessionStorage } from "@anaidev/daw-engine-core";
...
import { AudioEngine, Session } from "@anaidev/daw-engine-core";
...
| `lamejs`       | dependency      | MP3 export support         |
